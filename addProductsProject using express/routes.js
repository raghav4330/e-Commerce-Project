...
//----------------------------------------------------------------------------------------GET
             ...
             routes.get('/getproducts',function(request,response){
                   readInfo('files/products',function(info){
                       response.send(JSON.stringify(info));
                   });
               }); 
            
            routes.get("/getorderid",function(request,response){
                   readInfo('files/nextorderid',function(info){
                       response.send(JSON.stringify(info));
                   });
                });
            
            routes.get("/getorders",function(request,response){
...
//---------------------------------------------------------------------------------------------POST
               ...
               routes.post("/adduseraccount",function(request,response){
                ...
                routes.post("/addadminaccount",function(request,response){ 
                  account=request.body;
             ...
             routes.post("/checkLOGINuseraccounts",function(request,response){
             ...
             routes.post("/checkSIGNUPuseraccounts",function(request,response){
                    console.log("enteted");
            ...
            routes.post("/checkLOGINadminaccounts",function(request,response){
                    console.log("entered");
                   data=request.body;
                       console.log(data.email);
            ...
            routes.post("/checkSIGNUPadminaccounts",function(request,response){
                    console.log("enteted");
                   data=request.body.email;
                       console.log(data);
            ...
            routes.post("/addproduct",function(request,response){
            ...
            routes.post("/deleteproduct",function(request,response){
                    console.log("enteted");
            ...
            routes.post("/updateproduct",function(request,response){
                    console.log("enteted");
                   data=request.body;
                       console.log(data);
            ...
            routes.post("/getcartproducts",function(request,response){
                    data=request.body.acc;
                        getStoredCartProducts(data,'files/cartproducts',response);
                });
            
            routes.post("/addcartproduct",function(request,response){
                    console.log("entered add product");
                   data=request.body;
                       console.log(data);
            ...
            routes.post("/deletecartproduct",function(request,response){
                    console.log("enteted");
                   data=request.body;
                       console.log(data);
            ...
            routes.post("/updatecartproduct",function(request,response){
                   data=request.body;
                       console.log(data);
            ...
            routes.post("/getproducts_corespondingtoCart",function(request,response){
                   data=request.body.acc;
                       console.log(data);
            ...
            routes.post("/placeorder",function(request,response){
                    data=request.body;
            ...
            routes.post("/get_openedorder_detail",function(request,response){
                   data=request.body.orderid;
                       console.log(data);
